...
`)),s?this.registry.get(r):this.registry.define(r,i)}},R(e,"__registry",window.customElements),e},en=ae(Qt);var tn=n=>class extends n{static get shadowRootOptions(){return this.__shadowRootOptions||{mode:"open"}}static set shadowRootOptions(t){this.__shadowRootOptions=t}get shadowRootOptions(){return this.constructor.shadowRootOptions}createRenderRoot(){return this.shadowRoot??this.attachShadow(this.shadowRootOptions||{mode:"open"})}connectedCallback(){typeof super.connectedCallback=="function"&&super.connectedCallback(),this.renderRoot==null&&(this.renderRoot=this.createRenderRoot())}},nn=ae(tn);var dt="1.0.2";var G=class extends pe(D){constructor(){super(),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{t.define(e)})}getTextDirection(){return this.matches(":dir(rtl)")?"rtl":"ltr"}};R(G,"dependencies",{}),R(G,"version",dt);var ct=H`
  *,
  *:after,
  *:before {
...
lit-html/is-server.js:
   ...
   *)
*/
//# sourceMappingURL=/diff-view-element/bridgetown/static/chunks/chunk-RAYE5O6Z.js.map
