...
`)),s?this.registry.get(r):this.registry.define(r,i)}},R(e,"__registry",window.customElements),e},en=ae(Qt);var tn=n=>class extends n{static get shadowRootOptions(){return this.__shadowRootOptions||{mode:"open"}}static set shadowRootOptions(t){this.__shadowRootOptions=t}get shadowRootOptions(){return this.constructor.shadowRootOptions}createRenderRoot(){return this.shadowRoot??this.attachShadow(this.shadowRootOptions||{mode:"open"})}connectedCallback(){typeof super.connectedCallback=="function"&&super.connectedCallback(),this.renderRoot==null&&(this.renderRoot=this.createRenderRoot())}},nn=ae(tn);var dt="1.0.3";var G=class extends pe(D){constructor(){super(),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{t.define(e)})}getTextDirection(){return this.matches(":dir(rtl)")?"rtl":"ltr"}};R(G,"dependencies",{}),R(G,"version",dt);var ct=H`
  *,
  *:after,
  *:before {
...
lit-html/is-server.js:
   ...
   *)
*/
//# sourceMappingURL=/diff-view-element/pull/3/bridgetown/static/chunks/chunk-N5Y66C4M.js.map
